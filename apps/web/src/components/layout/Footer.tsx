      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <p className="text-lg font-semibold text-gray-900 dark:text-white">Velozity</p>
            <p className="text-base text-gray-500 dark:text-gray-400 max-w-xs">
              Modern project management dashboard with real-time collaboration, 
              role-based access control, and intelligent automation.
            </p>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-800 pt-8">
          <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
            &copy; {currentYear} Velozity, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
