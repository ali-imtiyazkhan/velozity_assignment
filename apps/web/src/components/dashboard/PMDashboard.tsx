...
import type { PMDashboardStats } from '../../types/api';
...
export function PMDashboard({ data }: { data: PMDashboardStats }) {
  const stats = [
    { title: 'My Projects', value: data.myProjects, icon: '📁', color: 'bg-blue-100 text-blue-600' },
    { title: 'Total Tasks', value: data.totalTasks, icon: '📋', color: 'bg-green-100 text-green-600' },
